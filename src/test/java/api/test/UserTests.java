...
public class UserTests {
	...
	Response response=	UserEndPoints.createUser(userPayload); //it will return respone
	...
	public void testupdateuser(){
		...
		userPayload.setLastname(faker.name().lastName());
		userPayload.setEmail(faker.internet().safeEmailAddress());
	Response response=	UserEndPoints.updateUser(this.userPayload.getUsername(),userPayload); //it will return respone
		response.then().log().all();
